...
Ignore le contexte, les définitions et les procédures internes à l'administration.
...
def verifier(exigence, index):
    preuves = index.recherche(exigence["texte"], k=4)
    if not preuves:
    ...
    rep = appel_json(PROMPT_VERDICT, f"EXIGENCE : {exigence['texte']}\n\nEXTRAITS :\n{bloc}")
